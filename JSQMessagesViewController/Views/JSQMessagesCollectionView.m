...
- (void)jsq_configureCollectionView
{
    ...
    [self registerNib:[JSQMessagesCollectionViewCellNeutral nib]
          forCellWithReuseIdentifier:[JSQMessagesCollectionViewCellNeutral cellReuseIdentifier]];
    ...
    [self registerNib:[JSQMessagesCollectionViewCellNeutral nib]
          forCellWithReuseIdentifier:[JSQMessagesCollectionViewCellNeutral mediaCellReuseIdentifier]];
